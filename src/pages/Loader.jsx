...
import './css/subpagescss/loader.css'
 ...
 () => {
  ...
  return (
    <div>
      ...
      {loading ? (
        <div className="svg-calLoader">
          <svg xmlns="http://www.w3.org/2000/svg" width="230" height="230" style={{ width: '230px', height: '230px', transformOrigin: '115px 115px', animation: '1.4s linear infinite loader-spin' }}>
